public class Dealership extends Entity {
	...
	public static void main(String[] args) {
		...
		Employee master = new Employee("master","somewhere",0,0,"password");
		Employee emp1 = new Employee("Adel", "JNA 40", 0, 0, "password");
		Employee emp2 = new Employee("Leda", "JNA 40", 0, 0, "password");
	...
	/*	
		while(!logIn) {
			...
			System.out.println("Wellcome to " + dealership.getName() + "!");
